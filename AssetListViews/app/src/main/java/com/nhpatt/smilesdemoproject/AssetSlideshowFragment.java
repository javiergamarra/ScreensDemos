 ...
 */
public class AssetSlideshowFragment extends Fragment implements BaseListListener<AssetEntry> {

    public static AssetSlideshowFragment newInstance() {

        Bundle args = new Bundle();

        AssetSlideshowFragment fragment = new AssetSlideshowFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.asset_slideshow, container, false);
        AssetListScreenlet assetListScreenlet = (AssetListScreenlet) view.findViewById(R.id.asset_list_slideshow_screenlet);
